...
const Footer = () => {
  ...
  return (
    <div className="bg-black">
      ...
      <div className="mx-auto pt-10 pb-5 text-center flex flex-col gap-y-5 items-center justify-center">
      <div className="">
                <label
                  className="text-sm pb-2 flex gap-2 items-center text-white"
                  htmlFor="email"
                >
